<h1 align="center">Welcome to Ubiquiti Config Editor 👋</h1>

<div align="center">

[![GitHub Releases](https://img.shields.io/github/v/release/biostudio/ubiquiti-config-editor?color=important&style=for-the-badge)](https://github.com/biostudio/ubiquiti-config-editor/releases)
[![GitHub Release Date](https://img.shields.io/github/release-date/biostudio/ubiquiti-config-editor?style=for-the-badge)](https://github.com/biostudio/ubiquiti-config-editor/releases)
[![GitHub issues](https://img.shields.io/bitbucket/issues/biostudio/ubiquiti-config-editor?style=for-the-badge)](https://github.com/biostudio/ubiquiti-config-editor/issues)
[![GitHub watchers](https://img.shields.io/github/watchers/biostudio/ubiquiti-config-editor?style=for-the-badge)](https://github.com/biostudio/ubiquiti-config-editor/watchers)
[![GitHub forks](https://img.shields.io/github/forks/biostudio/ubiquiti-config-editor?style=for-the-badge)](https://github.com/biostudio/ubiquiti-config-editor/fork)
[![GitHub stars](https://img.shields.io/github/stars/biostudio/ubiquiti-config-editor?style=for-the-badge)](https://github.com/biostudio/ubiquiti-config-editor/stargazers)
...
[![GitHub Releases (by Release)](https://img.shields.io/github/downloads/biostudio/ubiquiti-config-editor/total?color=success&style=for-the-badge)](https://github.com/biostudio/ubiquiti-config-editor/releases/tag/1.3)
...
<b>Ubiquiti Config Editor</b> is a powerful tool for quickly and intuitively modifying configuration files on Ubiquiti devices, with a focus on AirMAX M and AC line devices.
